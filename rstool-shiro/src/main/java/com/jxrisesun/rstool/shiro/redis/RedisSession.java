 ...
 * @since 0.1
 */
public class RedisSession implements ValidatingSession, Serializable {


    /**
	 * 
	 */
	private static final long serialVersionUID = -8584052117037722692L;

	//TODO - complete JavaDoc
    private transient static final Logger log = LoggerFactory.getLogger(RedisSession.class);
