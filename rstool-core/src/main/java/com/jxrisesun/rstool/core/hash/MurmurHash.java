...
import com.jxrisesun.rstool.core.util.ByteUtils;
import com.jxrisesun.rstool.core.util.CharsetUtils;
...
public class MurmurHash implements Serializable{
	...
	public static int hash32(CharSequence data) {
		return hash32(StringUtils.toBytes(data, DEFAULT_CHARSET));
	}
	...
	public static int hash32(byte[] data, int length, int seed) {
		...
		for (int i = 0; i < nblocks; i++) {
			int i4 = i << 2;
			int k = ByteUtils.bytesToInt(data, i4, DEFAULT_ORDER);
	...
	public static long hash64(CharSequence data) {
		return hash64(StringUtils.toBytes(data, DEFAULT_CHARSET));
	}
	...
	public static long hash64(byte[] data, int length, int seed) {
		...
		for (int i = 0; i < nblocks; i++) {
			final int i8 = i << 3;
			long k = ByteUtils.bytesToLong(data, i8, DEFAULT_ORDER);
	...
	public static long[] hash128(CharSequence data) {
		return hash128(StringUtils.toBytes(data, DEFAULT_CHARSET));
	}
	...
	public static long[] hash128(byte[] data, int length, int seed) {
		...
		for (int i = 0; i < nblocks; i++) {
			final int i16 = i << 4;
			long k1 = ByteUtils.bytesToLong(data, i16, DEFAULT_ORDER);
			long k2 = ByteUtils.bytesToLong(data, i16 + 8, DEFAULT_ORDER);
