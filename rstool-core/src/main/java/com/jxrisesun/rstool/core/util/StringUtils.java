...
import com.jxrisesun.rstool.core.text.AntPathMatcher;
...
public class StringUtils {
	...
	public static boolean startWith(CharSequence str, CharSequence prefix, boolean ignoreCase, boolean ignoreEquals) {
		...
		if (isStartWith) {
			return (false == ignoreEquals) || (false == StringUtils.equals(str, prefix, ignoreCase));
		}
		return false;
	}
	...
	*/
	...
	public static String format(final String strPattern, final Object... argArray) {
		...
		for (int argIndex = 0; argIndex < argArray.length; argIndex++) {
			...
			// 转义符
			if (delimIndex > 0 && strPattern.charAt(delimIndex - 1) == CharUtils.CHAR_BACKSLASH) {// 转义符
				if (delimIndex > 1 && strPattern.charAt(delimIndex - 2) == CharUtils.CHAR_BACKSLASH) {// 双转义符
					...
					argIndex--;
					sbuf.append(strPattern, handledPosition, delimIndex - 1);
					sbuf.append(CharUtils.CHAR_DELIM_START);
